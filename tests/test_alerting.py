...
def test_alert_aggregator():
    ...
    alert1 = Alert(title="Alert 0", message="Test", severity=AlertSeverity.LOW)
    ...
    alert2 = Alert(title="Alert 1", message="Test", severity=AlertSeverity.LOW)
    result = aggregator.add_alert(alert2, "test_group")
    assert result is None

    # Add third alert - should still not trigger (only 2 so far)
    alert3 = Alert(title="Alert 2", message="Test", severity=AlertSeverity.LOW)
    ...
    alert4 = Alert(title="Alert 3", message="Test", severity=AlertSeverity.LOW)
...
def test_console_channel():
    ...
    alert = Alert(title="Test Alert", message="Console test", severity=AlertSeverity.MEDIUM)
