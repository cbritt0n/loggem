...
from loggem.core.models import AnalysisResult, Anomaly, AnomalyType, LogEntry, Severity
...
class TestLogEntry:
    ...
    def test_create_basic_entry(self):
        ...
        entry = LogEntry(
            timestamp=datetime.now(), source="test", message="Test message", raw="raw log line"
        )
    ...
    def test_validate_level(self):
        ...
        entry = LogEntry(
            timestamp=datetime.now(), source="test", message="Test", level="invalid", raw="raw"
        )
    ...
    def test_get_hash(self):
        ...
        entry1 = LogEntry(
            timestamp=datetime.now(), source="test", message="Same message", raw="raw1"
        )
        entry2 = LogEntry(
            timestamp=entry1.timestamp, source="test", message="Same message", raw="raw2"
        )
...
class TestAnomaly:
    ...
    def test_create_anomaly(self):
        ...
        entry = LogEntry(timestamp=datetime.now(), source="test", message="Test", raw="raw")
...
class TestAnalysisResult:
    ...
    def test_get_anomalies_by_severity(self):
        ...
        result = AnalysisResult(total_entries=1, anomalies=anomalies, duration=1.0)
