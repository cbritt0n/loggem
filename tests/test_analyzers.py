...
class TestLogAnalyzer:
    ...
    def test_analyze_single_log(self):
        ...
        now = datetime.now()
        log = LogEntry(
            timestamp=now, message="test message", source="test", raw="test message"
        )
    ...
    def test_time_pattern_detection(self):
        ...
        logs = [
            ...
            LogEntry(timestamp=base_time + timedelta(seconds=1), message="msg2", source="app", raw="msg2"),
            LogEntry(timestamp=base_time + timedelta(seconds=2), message="msg3", source="app", raw="msg3"),
        ]
...
class TestPatternDetector:
    ...
    def test_benign_logs(self):
        ...
        logs = [
            LogEntry(timestamp=now, message="User logged in successfully", source="auth", raw="User logged in successfully"),
            LogEntry(timestamp=now, message="Application started", source="app", raw="Application started"),
            LogEntry(timestamp=now, message="Database query executed", source="db", raw="Database query executed"),
        ]
